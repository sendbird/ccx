...
type Session struct {
	...
	ShellJobs      []ShellJob // populated lazily when HasShellJobs is true (and eagerly for live sessions)
	AwaitingInput  bool       // live session blocked on an unanswered AskUserQuestion
